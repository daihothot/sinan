...
members = [
  "crates/sinan-types",
  "crates/sinan-protocol",
  "crates/sinan-domain",
  "crates/sinan-store",
  "crates/sinan-gateway",
  "crates/sinan-risk",
  "crates/sinan-execution",
  "crates/sinan-reconciliation",
  "crates/sinan-events",
  "crates/sinan-http",
  "crates/sinan-core",
]
...
use sinan_types::{
    AccountId, ClientId, CommandId, ErrorCode, ExecutionCommand, SessionId,
    TerminalId,
};
